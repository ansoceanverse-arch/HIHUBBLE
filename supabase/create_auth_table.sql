...
-- Description: Authentication & Profiles Schema Creation for New Supabase Project
-- ==============================================================================

-- 1. Enable UUID Extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 2. Create Profiles / Authentication Table
...
-- 3. Create Settings Table (Linked to Profiles)
...
-- 4. Indexes for Quick Authentication Lookups
